...
export const PLAY_TESTS = [
  {
    ...
    questions: [
    {
      ...
      answers: [
        <p>난 여러 성향을 갖고 있어. <br/> 다양하게 경험해볼수록 좋잖아?</p>,
        <p>난 검사는 해봤어!</p>,
        <p>내 성향에 대해 어느 정도 알기는 해.</p>,
        <p>검사는 안 해봤지만... 궁금하긴 해. <br/>뭔가 있는 것 같긴 하거든.</p>,
        <p>성향은 딱히 없어! <br/> 그냥 궁금하니까 한 번 해보는 거야 ㅋㅋ</p>,
      ],
    },
    {
      id: 1,
    ...
    },
    {
      id: 2,
      question:
        <p>애인이 바람피우는 꿈을 꾸다가 너무 열 받아서 깨버렸어. 내 꿈속에서 바람피운 애인의 모습은?</p>,
      answers: [
    ...
    },
    {
      id: 3,
      question:
        <p>오늘 밤, 침대에서 상대방을 제압하는 나의 손에는 어떤 물건이 있을까?</p>,
      answers: [
    ...
    },
    {
      id: 4,
      question:
        <p>비 오는 날, 말없이 나를 찾아온 상대방. 젖은 상대방의 모습 중 나를 가장 흥분시키는 포인트는?</p>,
      answers: [
        <p>다 젖은 머리로 나를 쳐다보는 청순가련 눈동자</p>,
        <p>바디 라인이 살짝살짝 보일 정도로 <br/>흠뻑 젖은 흰색 티셔츠</p>,
    ...
    },
    {
      id: 5,
      question:
        <p>오늘 밤, 내 명령은 뭐든지 다 들어준대! 어떤 식으로 명령하고 싶어?</p>,
      answers: [
    ...
    },
    {
      id: 6,
      question:
        <p>점점 지쳐가는 체력. 이 때 내 힘을 불끈불끈 솟게 해주는 상대방의 한 마디는?</p>,
      answers: [
    ...
    },
    {
      id: 7,
      question:
        <p>상대가 자신의 판타지였다는 하드한 플레이를 제안했다. 엄두조차 안 나는 플레이에 대한 내 대답은?</p>,
      answers: [
        <p>"아무리 판타지라고 해도 <br/>널 아프게 하면서까지 하고 싶진 않아..."</p>,
    ...
    },
    {
      id: 8,
      question:
        <p>오늘 처음 만난 사람, 네 이상형이야. 첫눈에 반해버렸어... 넌 오늘 밤 어디까지 갈 수 있어?</p>,
      answers: [
        <p>당연히 끝까지 갈 수 있지.</p>,
        <p>마음을 확인하는 입맞춤 정도는 괜찮지 않을까?</p>,
        <p>스킨십은 어림도 없어! <br/>그래도 내 마음을 전하는 고백은 하고 갈 거야.</p>,
    ...
    },
    {
      id: 9,
      question:
        <p>호텔에서 새로운 플레이를 제안하는 상대방! 방에 있는 물건 중 뭘 사용해볼까?</p>,
      answers: [
        <p>묶으면 쉽게 풀리지 않을 것 같은 <br/>아이보리색 암막커튼 끈</p>,
        <p>내 바지에 끼워져 있는 최고급 소가죽 벨트</p>,
        <p>눈을 가리면 아무것도 보이지 않는 <br/>벨벳 소재의 안대</p>,
    ...
    },
    {
      ...
      answers: [
        ...
        <p>매트리스인지 침대인지 구분이 안 될 정도로 <br/>출렁거리는 물침대 룸</p>,
    ...
    },
    {
      id: 11,
      question:
        <p>상대방이 갑자기 직장 상황극을 시작하며 나를 궁지에 몰기 시작했다. 상대방은 어떤 직장 동료일까?</p>,
      answers: [
        <p>나를 선배님이라고 부르는 <br/>열정 넘치고 풋풋한 신입사원</p>,
        <p>승진심사 기간, 내 약점을 쥐고 <br/>무언가를 원하는 눈빛의 인사팀장</p>,
        <p>늘 나한테 차갑게 대하다가 <br/>오늘은 뭔가 오묘한 기류가 흐르는 우리 팀 선배</p>,
      ],
    },
    {
      id: 12,
    ...
    },
    {
      id: 13,
      question:
        <p>성향이 맞지 않는 사람과 도저히 좁힐 수 없는 간극... 어떻게 할까?</p>,
      answers: [
  ...
  },
  {
    ...
    questions: [
    {
      ...
      answers: [
        <p>얼굴은 평범해도 <br/> 스타일리시한 옷스타일에 반해버렸다!</p>,
        <p>물 흐르듯이 자연스러운 대화와 <br/> 진지한 분위기에 빠져들었어!</p>,
        <p>상대도 괜찮은데 나도 모르게 <br/> 옆 자리 다른 이성에게 자꾸만 눈이 간다.</p>,
      ],
    },
    {
      id: 1,
    ...
    },
    {
      id: 2,
      question:
        <p>두근두근 첫 데이트, 내가 원하는 상대와의 데이트는?</p>,
      answers: [
    ...
    },
    {
      id: 5,
      question:
        <p>드디어 도착한 여행지 숙소. 그런데... 욕실이 통유리로 되어있다. 나의 행동은?</p>,
      answers: [
    ...
    },
    {
      id: 6,
      question:
        <p>저녁도 먹고 행복한 시간을 보낸 후, 샤워하러 간 상대를 기다리는 나의 모습은?</p>,
      answers: [
        <p>캔들과 음악 등 자연스러운 분위기를 만들고 기다린다.</p>,
        <p>침대와 주변을 둘러보고 <br/> 어떤 곳이 관계하기 좋을지 살펴본다.</p>,
  ...
  },
  {
    ...
    },
    {
      id: 6,
      question:
        <p>연인과 함께 근교 데이트하러 갈 때 나는</p>,
      answers: [
        <p>당일에 급하게 준비하며 <br/>가는 길에 데이트 장소를 한 번 찾아본다</p>,
    ...
    },
    {
      id: 9,
      question:
        <p>연인이 어떻게 해주는 게 좋아?라고 물어보면 나는</p>,
      answers: [
        <p>내가 원하는 방향성과 느낌을 얘기한다</p>,
        <p>잘할 수 있도록 <br/>구체적으로 어떻게 해주는 게 좋은지 얘기한다</p>,
      ],
    },
    {
      id: 10,
